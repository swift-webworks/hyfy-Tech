...
class EnquiryForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "required_date": forms.DateInput(attrs={"class": "form-control","placeholder":"Date", "type": "date"}),
            "facility_type": forms.TextInput(attrs={"class": "form-control", "placeholder": "Place / Facility Type"}),
            "service_required": forms.Select(attrs={"class": "form-select","placeholder":"Service Required", "required": True}),
